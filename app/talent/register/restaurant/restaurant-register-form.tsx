...
import { ownerRegister } from "@/server/actions/auth";
  ...
  return (
    <div className="mx-auto w-full max-w-sm px-6 py-20">
      ...
      <p className="mt-1 text-sm text-muted">
        Publicá oportunidades y conectá con talento gastronómico en VORA.
      </p>
      ...
      <form action={action} className="mt-8 space-y-4">
        ...
        >
          {pending ? "Creando cuenta..." : "Crear cuenta de empresa"}
        </button>
      </form>
