    ...
    <section className="border-y border-white/[0.05] bg-[#0b0b10] px-5 py-28 lg:px-8 lg:py-36">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-4xl font-semibold tracking-[-0.04em] sm:text-5xl">
            ...
            <span className="text-white/35">
              realmente necesitás contratar.
            </span>
          </h2>

          <p className="mt-5 text-base leading-7 text-white/40">
            VORA no necesita una suscripción mensual para una empresa que
            contrata de manera puntual. Creás una búsqueda y utilizás la red
            cuando tenés una necesidad real.
          </p>
        </div>
        ...
        <div className="mt-8 text-center text-xs text-white/30">
          Búsqueda y filtros gratuitos · Los desbloqueos se facturan según el
          uso.
        </div>
      </div>
    </section>
